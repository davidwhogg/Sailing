...
The curvature of the sails will in general lead to differences between the sail orientation we compute for GoodSailing(tm) and the orientation of, say, the boom of any real sailboat.
That is, in just the same sense that the areas are effective areas, the orientations are effective orientations.
