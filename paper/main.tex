...
\begin{figure}[t!]
  \includegraphics[width=0.3\textwidth]{design_A.pdf}\hfill%
  \includegraphics[width=0.3\textwidth]{design_C.pdf}\hfill%
  \includegraphics[width=0.3\textwidth]{design_E.pdf}
