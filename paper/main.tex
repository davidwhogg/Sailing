...
\begin{figure}[t!]
  ...
  As in \figref{fig:good}, when the keel orientation is too close to directly upwind, the boat goes downwind instead.\label{fig:hourgood}}
  \figurerule
\end{figure}
...
\begin{figure}[t!]
  ...
  BetterSailing(tm) often involves sailing at a substantial angle to the direct line towards the destination.\label{fig:better}}
  \figurerule
\end{figure}
