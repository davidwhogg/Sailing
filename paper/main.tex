...
HOGG: We make use of good, coordinate-free expressions.
...
If you think about \figref{fig:hourglass} in terms of the boat-air velocity instead of the boat-water velocity, the upwind travel has much larger boat-air velocities than the downwind travel.
...
\begin{figure}[t!]
  ...
  Compare this to \figref{fig:hourglass}.\label{fig:hourgood}}
  \figurerule
\end{figure}
